...
Invoke-RestMethod https://raw.githubusercontent.com/jacktheseb/osd_siegel/refs/heads/main/Install-EmbeddedProductKey.ps1 | Out-File -FilePath 'C:\Windows\Setup\scripts\productkey.ps1' -Encoding ascii -Force
